...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(AuthResponseModel model) succes,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(AuthResponseModel model)? succes,
...
class _$SuccesImpl implements _Succes {
  ...
  @override
  String toString() {
    return 'LoginState.succes(model: $model)';
  }
...
abstract class _Succes implements LoginState {
  const factory _Succes(final AuthResponseModel model) = _$SuccesImpl;
